...
pipeline = Pipeline([
    ...
    ("clf", RandomForestClassifier(n_estimators=30, max_depth=30, min_samples_split=5, random_state=42))
])
...
# Save model
# =====================
with open(r"C:\Users\mishr\OneDrive\Desktop\Finalyear\model_outputs\SentimentAnalysisLite.pickle", "wb") as f:
